...
describe('browser.tinymce.plugins.assets.EmojiAppendTest', () => {
  const hook = TinyHooks.bddSetupLight<Editor>({
    plugins: 'assets',
    toolbar: 'assets',
    base_url: '/project/tinymce/js/tinymce',
    assets_database_url: '/project/tinymce/src/plugins/assets/test/js/test-emojis.js',
    assets_database_id: 'tinymce.plugins.assets.test-emojis.js',
    assets_append: {
      clock: {
        keywords: [ 'clock', 'time' ],
        char: '⏲'
