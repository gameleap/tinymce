...
const defaultMenus: Record<string, MenuSpec> = {
  ...
  insert: { title: 'Insert', items: 'image link media addcomment pageembed template inserttemplate codesample inserttable accordion | charmap emoticons assets hr | pagebreak nonbreaking anchor tableofcontents footnotes | mergetags | insertdatetime' },
